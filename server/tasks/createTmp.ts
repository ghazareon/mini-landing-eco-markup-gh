...
/* prettier-ignore */ import sizeOf           from "image-size";
/* prettier-ignore */ import { tmpPaths }     from "@/src/shared/config/const/paths";
/* prettier-ignore */ import { removeDouble } from "@/src/shared/utils";
...
fs
	...
	.then(async (result) => {
		fs.writeFile(
			tmpPaths.outFile,
			await prettier.format(`${result}`, { parser: "scss" }),
		);
	});
